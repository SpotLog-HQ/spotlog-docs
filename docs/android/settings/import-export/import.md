...
Headcode can import data from a **full backup** file (`.zip`) that was previously created using the [Full Export](/android/settings/import-export/export-full) feature.
