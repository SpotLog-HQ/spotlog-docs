...
prev:
  text: Appearance
  link: /android/settings/preferences/appearance
next:
  text: Reminders
  link: /android/settings/preferences/reminders
---
...
This setting controls how many days of no spotting activity will trigger a reminder.

<!-- Screenshot: The inactivity threshold picker showing options from 1-14 days -->
...
Control when notifications can be sent to avoid being disturbed at inconvenient times.

<!-- Screenshot: The notification window picker showing start and end time -->

Set your preferred window by choosing:

- **Start time** - Earliest time notifications can be sent
- **End time** - Latest time notifications can be sent

Notifications will only be sent within this window. For example, setting 09:00 to 21:00 means you won't receive notifications during the night.
