...
prev:
  text: Notifications
  link: /android/settings/preferences/notifications
next:
  text: Widgets
  link: /android/settings/widgets
---
...
**Toggle off** if you:
- Rarely take photos of your spots
- Prefer to add photos later
- Find the prompt disruptive to your workflow
...
**Toggle off** if you:
- Always use Quick Spots for fast, minimal entries
- Prefer to edit spots later rather than immediately
- Find the prompt slows down your spotting
...
- You can always add details or photos later by [editing a spot](/android/my-spots/edit-a-spot)
- These settings don't affect [notification reminders](/android/settings/preferences/notifications)