...
1. Find the spot you want to delete in the [My Spots](/ios/my-spots/index) list
...
::: danger
Deleting a spot is permanent and cannot be undone. Make sure you have a [backup](/ios/settings/import-export/export-full) if you want to preserve your data.
:::

## Deleting All Spots

If you want to delete all your spots at once, use the [Delete All Spots](/ios/settings/delete-all-spots) option in Settings. This is useful if you want to start fresh.
