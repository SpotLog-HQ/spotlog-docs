...
prev:
  text: Spot Details
  link: /ios/my-spots/spot-details
next:
  text: Delete a Spot
  link: /ios/my-spots/delete-a-spot
---
...
1. Find the spot you want to edit in the [My Spots](/ios/my-spots/index) list
...
3. The edit screen opens with all existing data pre-filled

## The Edit Screen

The edit screen is the same as the [Detailed Log](/ios/detailed-log/index) screen, but with all your existing data pre-filled. You can:
...
<a href="/images/ios/loco-details-edit.png" target="_blank">
  <img
...
- Train details
- Notes
- Everything else from the Detailed Log

## Tips

- Use edit to add details to Quick Spots later
- Add photos after the fact if you forgot during initial logging
- Correct typos in locomotive numbers or names
