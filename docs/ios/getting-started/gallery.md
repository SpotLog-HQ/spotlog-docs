...
prev:
  text: Calendar
  link: /ios/getting-started/calendar
next:
  text: Searching
...
If you haven't added any photos to your spots yet, the Gallery will show a message prompting you to add photos. You can add photos when creating a [Quick Spot](/ios/getting-started/quick-log) or a [Detailed Spot](/ios/detailed-log/photos).
