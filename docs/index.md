...
features:
  - title: Getting Started
    details: Learn the basics of Headcode, including Quick Log, Stats, Calendar, Gallery, and Search.
    link: /ios/getting-started/index
  ...
  - title: Request A Feature
    ...
    linkText: Request It
  - title: Report A Bug
    details: Found something that doesn't work? Let us know so we can fix it.
    link: https://github.com/Headcode-HQ/issues/issues
    linkText: Report It
---

## Welcome to Headcode Support

Headcode is the train spotting companion app designed for UK rail enthusiasts. Whether you're logging quick sightings or recording detailed information with photos, Headcode helps you keep track of every locomotive you see.
...
If you can't find what you're looking for in this documentation, [contact us](mailto:support@Headcode.app) and we'll get back to you as soon as possible.